...
sidebar_position: 13
sidebar_label: 12. Where to find work
description: Companies, communities, and the indie path. The 2026 AI-engineer job market in one page, with named places to look.
---
...
1. **Pick 15–30 target companies** across two tiers (e.g., 5 frontier labs as stretch, 15 scaleups as primary, 10 non-AI SaaS as backup).
2. **For each, identify the team you'd join** (browse their engineering blog, find the team page, read recent talks).
3. **For each, write one targeted note** — to a hiring manager, an engineer on the team, or a recruiter — referencing a specific artifact of theirs and one of yours.
4. **Apply formally in parallel** to the same 15–30 — but the warm thread is what gets the interview.
5. **Show up in 2 communities** (e.g., Latent Space Discord + AI Tinkerers SF chapter) consistently for 3+ months.
6. **Re-evaluate every 6 weeks.** If you're not getting first-round interviews, the bottleneck is either the artifact (no shipped portfolio) or the outreach (cold + generic).
...
:::note[Worked example: a focused 2026 job search]
...
:::info[Highlight: referrals are the single biggest junior-search lever]
