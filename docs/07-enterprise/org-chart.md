...
flowchart TB
    ...
    CDO["Chief Data Officer / Chief AI Officer"]
    VPPlat["VP Platform"]
    VPProd["VP Product"]
    Plat["AI Platform team"]
    DevEx["Internal AI Productivity"]
    CoE["AI Center of Excellence (virtual)"]
    RAI["Responsible AI / Governance"]
    Risk["Named Risk/Legal/Privacy/Security partners"]
    FT["Feature teams (embedded AI engineers)"]
    CEO --> CTO
    CEO --> CRO
    CEO --> GC
    CTO --> VPPlat
