---
id: communities-and-conferences
title: Communities and Conferences
sidebar_position: 4
sidebar_label: Communities & conferences
description: Where production AI engineers actually congregate. AI Engineer Summit, NeurIPS, Latent Space, Discords, Reddit — what each is for.
---
...
- **Anthropic, OpenAI, Mistral engineering blogs** — see [Papers worth reading](./02-papers-worth-reading.md).
...
1. Lurk for 2 weeks. Read the top threads. Understand the culture and what people actually post about.
2. Answer easy questions when you can. Lower-status; high-trust-building.
3. Ask one substantive question when you have something specific (not "how do I learn AI").
4. Participate from there.
